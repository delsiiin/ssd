            ...
            for idx, decoder_layer in enumerate(self.layers):
                ...
                if self.gradient_checkpointing and self.training:
                    ...
                    def create_custom_forward(module):
                        def custom_forward(*inputs):
                            # None for past_key_value
                            return module(*inputs, past_key_value, output_attentions, padding_mask=padding_mask, draft_attn_skip_mask=draft_attn_skip_mask, draft_mlp_skip_mask=draft_mlp_skip_mask)
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        outputs = self.model(
            ...
            draft_attn_skip_masks=self.ssd_layer_groups[0],
            draft_mlp_skip_masks=self.ssd_layer_groups[1],
        ...
        if self.config.pretraining_tp > 1:
            ...
            for draft_hidden_states in all_draft_hidden_states:
