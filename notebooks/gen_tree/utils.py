...
def initialize_ssd(input_ids, model, ssd_attn_mask, past_key_values, top_layers_len, attn, past_key_values_attn):
    """
    ...
    if attn:
        ...
        input_ids, past_key_values=past_key_values, past_key_values_attn=past_key_values_attn, top_layers_len=top_layers_len
    )
    else:
        ssd_logits, logits = model(
