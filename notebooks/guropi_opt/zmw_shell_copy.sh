...
# python run_searching.py --num_group 4 --num_sample 8 --searching_method bayesian --ts_layer_level \
#         --bayesian_itr 500 --max_seq_length 2048 --max_new_tokens 32 --top_layers_level --top_layers_len 20

# python run_searching.py --num_group 4 --num_sample 8 --searching_method bayesian --ts_layer_level \
#         --bayesian_itr 600 --max_seq_length 2048 --max_new_tokens 32 --top_layers_level --top_layers_len 20
